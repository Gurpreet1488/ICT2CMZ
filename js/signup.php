            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="logo_area text-center">
                        <a href="home.html" class="yummy-logo">CMZ Pvt. LTD</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" action="server.php" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password_2" id="password_1" placeholder="Repeat your password"/>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-12">
                    <div class="footer-content">
                        ...
                        <div class="footer-logo-area text-center">
                            <a href="index.html" class="yummy-logo">CMZ Pvt. LTD</a>
                        </div>
                        <!-- Menu Area Start -->
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse justify-content-center" id="yummyfood-footer-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="archive.html">Distributor</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">About us</a>
                                </li>
